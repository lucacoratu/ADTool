...
type MachineInformation struct {
	...
	NetInterfaces []NetworkInterface `json:"networkInterfaces"` //List of network interfaces
	OsCurrentUser OsUser             `json:"osCurrentUser"`     //Current user from the operating system
}
